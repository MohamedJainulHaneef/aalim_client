...
import AddPopup from '../../components/manage/user/AddPopup';
...
function UserManage() {
    ...
    return (
        <div className="min-h-screen p-3">
            {/* Structural Main Header Card Section */}
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-slate-200/80 pb-5 mb-6 gap-4">
                <div>
                    ...
                    <p className="text-xs text-slate-400 font-medium tracking-normal mt-0.5">
                        Manage, coordinate and update registered system accounts.
                    </p>
                </div>
            ...
            {/* Dashboard Workspace Rendering Toggle */}
