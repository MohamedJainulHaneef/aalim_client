...
const LoginForm = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col justify-center bg-gradient-to-r from-cyan-400 via-blue-400 to-indigo-600 px-8 pb-20 lg:pb-0 gap-5 lg:items-center">
            ...
            <div className="rounded-2xl shadow-lg text-black bg-white py-6 px-6 lg:py-10 lg:px-10">
                ...
                <div className="flex items-center border-b-2 border-black mb-8 p-1 lg:mb-12 relative">
                ...
                <button
                    ...
                    className="w-full text-white h-8 lg:h-10 bg-orange-400 hover:bg-orange-500 text-2xl font-semibold rounded-md shadow-md flex items-center justify-center"
                >
                    <FontAwesomeIcon icon={faLock} className="mr-2 text-sm" />
                    <span className="text-sm font-serif uppercase">
